...
For every unit increase in level of risk reduction, the respondent is more likely to vote yes by 0.004169 units. 
...
$$Odds(Voting Yes) = 0.1196977 + \beta_1(Risk) + \beta_2(BID) +  \beta_3 + (NEP)+\beta_4(Income) + \beta_5(Age)$$

$$Odds(Voting~Yes) = 0.1196977 + 0.0204401(Age_30_) -0.0201190(Age_40_) + 0.0099816(Age_50__)  -0.0162261(Age_60_) + 0.0027386(Poor) + 0.0074891(Rich) + 0.0467922(Very~Rich) + 0.0088282(One~Percent) + 0.0158639(NEP) + 0.0007445(Risk) - 0.0010699(BID)$$
...
# bid = -28.45266
```
#Based on this regression, what can you say about the value of a single prevented whale death? (Hint: Think about how risk reduction for all whales translates into the number of whale deathsavoided) (4% reduction in risk = 1 whale saved)
