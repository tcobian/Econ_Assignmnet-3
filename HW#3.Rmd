...
bid_7<- function(x){(0.1196977 + 0.0204401*1 + 0.0158639*50 + 0.0007445*x - 1)/0.0010699}
bid_7(60)
...
p_10<- function(x){ (0.1196977 + 0.0204401*1 + 0.0027386*1 + 0.0158639*32 + 0.0007445*x - 1)/0.0010699}
...
p_1<- function(x){(0.1196977 + 0.0204401*1 + 0.0467922*1 + 0.0158639*15 + 0.0007445*x -1)/0.0010699}
